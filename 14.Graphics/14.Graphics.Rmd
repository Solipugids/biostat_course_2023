...
knitr::opts_chunk$set(tidy = TRUE, prompt = TRUE, comment = "#")
```
...
\tiny
```{r, eval=TRUE, echo=TRUE, warning=FALSE, size='tiny'}
library(tableone)
table2 <- CreateTableOne(vars = c('x.Age', 'x.Gender', 'CVD'), data = data, factorVars = c('x.Gender', 'CVD'), strata = 'Smoke', smd=TRUE)
