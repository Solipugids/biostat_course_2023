...
x <- seq(0, 4)
plot(x, -3+2*x, type = 'l', lwd = 2, xlim = c(0, 4), ylim = c(0, 4), xlab = "x", ylab = "y", col= "black")
text(3.5, 3, expression(y==2%*%x -3))
lines(x, 2+2*x, type = "l", lwd = 2, col= 'red')
text(1, 3, expression(y==2%*%x +2), col = 'red')
lines(x, 3-2*x, type = "l", lwd = 2, col= 'blue')
text(1, 1, expression(y==-2%*%x +3), col = 'blue')
lines(x, rep(2, length(x)), type = "l", lwd = 2, col= 'orange')
text(2, 2.1, expression(y==2), col = 'orange')
```
