...
## 课程资源
- Github：[ Solipugids/biostatistics_course_2022](https://github.com/Solipugids/biostatistics_course_2022.git)
- 下载Github Desktop后选择`Clone reposit...`
- 安装git后在**终端**中输入命令 `git clone https://github.com/Solipugids/biostatistics_course_2022.git`
...
- 计算工具：![RStudio](./rstudio_logo.png){width=10%} RStudio <https://www.rstudio.com/>
