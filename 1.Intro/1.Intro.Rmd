...
-   办公室地址：广东药科大学科技楼五楼
-   研究方向：药物靶向设计，系统/计算生物学，中西医结合临床医学
...
-   2024年第一学期\textcolor{red}{11周至19周}，周三/每周
-   晚间\textcolor{red}{18：30至21：30}
-   9次课程
    -   概论 Intro
    -   概率 Probability
    -   统计推断 Inference
    ...
    -   协方差 Coviriance
    -   逐步回归和多项式回归 Stepwise & Polynomial Regression
...
-   RStudio Server
    -   校内网访问地址 10.91.10.83:8787（通过发送邮件申请使用权限）
    -   官方 <https://posit.cloud/> (自行注册账号使用)
...
- 统计学主要研究随机现象的数量规律，是用数理统计的原理和方法来分析和解释生物界各种现象和试验调查资料的科学

- 医学统计学是数理统计在生物医学研究中的应用

- 属于生物数学的范畴

    - 涉及到概率和微积分等知识
      - 概率论：集合（子集，并集，交集……），排列组合
      - 线性代数：函数，导数，微积分
      - 矩阵

Tm：随温度升高，双链DNA的双螺旋结构发生降解，全部双螺旋结构降解一半的温度称为双链DNA的溶解温度Tm
```{r echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics("./melting_curve.jpg")
```
...
-   证券市场的大盘指数在一段时间里，会在一定的价格区间内上下波动，偶尔会短时间超出这个区间（震荡）
-   黑色星期四
...
knitr::include_graphics("./galton_board.png")
```
高尔顿板（Galton Board）
...
-   分析父母和子女的变异，探寻遗传规律，应用统计方法研究人种特性和遗传
    ...
    -   罗纳德·费舍尔：自然选择的遗传理论 The Genetical Theory of Natural Selection，1930年
...
- 数据分布难以通过正态性检验
  ...
  - 正态性不被明确的研究结果推翻的情形下，尽量采用正态性方法，以保证检验功效和结果的可解释性
  - 正态检验
  
- 数值变量的连续性

  - 除了无序的分类变量外，本质可以认为大部分数据理论上是连续的
  - 对变量的表述不必过于强调其连续与否，可以笼统为数值变量
